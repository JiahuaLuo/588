...
DOCX_OUT = ROOT / "reports" / "EE588_AWG_Final_Project_Report.docx"
...
def prepare_assets() -> None:
    ...
    for name in [
        ...
        "awg_transmission_spectra.png",
        "awg_channel_metrics.png",
    ]:
        src = ASSETS / name
...
def build_html() -> Path:
    ...
    metrics_df = pd.read_csv(TABLES / "awg_channel_metrics.csv")
