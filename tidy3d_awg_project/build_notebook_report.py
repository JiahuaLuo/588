...
DOCX_OUT = ROOT / "EE588_HW3_Notebook_Report.docx"
...
def build_html() -> Path:
    ...
    channel_df = pd.read_csv(ROOT / "awg_channel_plan.csv")
    lengths_df = pd.read_csv(ROOT / "awg_arrayed_waveguide_lengths.csv")
    ...
    if figures["available"]:
        figure_rows = [[name, "Generated by the notebook and kept in project/tidy3d_awg_project/report_assets/"] for name in figures["available"]]
        sections.extend(
            [
