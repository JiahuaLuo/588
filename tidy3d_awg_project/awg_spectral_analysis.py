...
SPECTRUM_CSV = ROOT / "awg_simplified_spectrum.csv"
METRICS_CSV = ROOT / "awg_channel_metrics.csv"
SUMMARY_MD = ROOT / "AWG_FINAL_RESULTS.md"
...
def write_summary(params: dict[str, float], metrics_df: pd.DataFrame) -> None:
    ...
    lines.extend(
        [
            ...
            "## Output Files",
            "",
            "- `awg_simplified_spectrum.csv`",
            "- `awg_channel_metrics.csv`",
